...
class ProcessRelations
{
            ...
            try {
                switch (get_class($relationship)) {
                    ...
                    case HasOneOrMany::class:
                        self::processRelationshipHasOneOrMany($model, $relationship, $resourceData);
                        break;
                    ...
                    case MorphOneOrMany::class:
                        self::processRelationshipMorphOneOrMany($model, $relationship, $resourceData);
                        break;
    ...
    public static function processRelationshipHasOneOrMany(Model $model, $relationship, $resourceData)
    {
        throw new \Exception('The relationship ' . get_class($relationship) . ' is not implemented yet by backend!');
    }
    ...
    public static function processRelationshipMorphOneOrMany(Model $model, $relationship, $resourceData)
    {
        throw new \Exception('The relationship ' . get_class($relationship) . ' is not implemented yet by backend!');
    }
